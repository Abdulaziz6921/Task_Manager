...
// Filter tasks________________________________________

form1["form__input"].addEventListener("input", (e) => {
  let inputValue = e.target.value.toLowerCase();
  let allText = document.querySelectorAll(".text");
  console.log(allText);
  console.log(inputValue);
  allText.forEach((text) => {
    if (text.lastElementChild.textContent.toLowerCase().includes(inputValue)) {
